...
})(TapType || (exports.TapType = TapType = {}));
var HookType;
(function (HookType) {
    ...
    HookType["ContextModuleFactoryHook"] = "ContextModuleFactoryHook";
    HookType["NormalModuleFactoryHook"] = "NormalModuleFactoryHook";
...
class Operation {
    constructor() {
        ...
        this.normalModuleFactoryHookCallbackParameters = new options_1.NormalModuleFactoryHookCallbackParameters();
        this.contextModuleFactoryHookCallbackParameters = new options_1.ContextModuleFactoryHookCallbackParameters();
    }
