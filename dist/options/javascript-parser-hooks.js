...
JavascriptParserHookCallbackParameters.PROPERTIES = 'properties';
class JavascriptParserHookInitializer {
    static initHooks(container) {
        ...
        container.evaluateIdentifier = new options_1.JavascriptParserHook(JavascriptParserHookNames.i.evaluateIdentifier, options_1.WebpackHookType.SyncBailHook, [JavascriptParserHookCallbackParameters.EXPRESSION], false);
        container.evaluateDefinedIdentifier = new options_1.JavascriptParserHook(JavascriptParserHookNames.i.evaluateDefinedIdentifier, options_1.WebpackHookType.SyncBailHook, [JavascriptParserHookCallbackParameters.EXPRESSION], false);
        container.evaluateCallExpressionMember = new options_1.JavascriptParserHook(JavascriptParserHookNames.i.evaluateCallExpressionMember, options_1.WebpackHookType.SyncBailHook, [JavascriptParserHookCallbackParameters.EXPRESSION, JavascriptParserHookCallbackParameters.PARAM], true);
        ...
        container.typeof = new options_1.JavascriptParserHook(JavascriptParserHookNames.i.typeof, options_1.WebpackHookType.SyncBailHook, [JavascriptParserHookCallbackParameters.EXPRESSION], false);
        ...
        container.callMemberChain = new options_1.JavascriptParserHook(JavascriptParserHookNames.i.callMemberChain, options_1.WebpackHookType.SyncBailHook, [JavascriptParserHookCallbackParameters.EXPRESSION, JavascriptParserHookCallbackParameters.PROPERTIES], true);
