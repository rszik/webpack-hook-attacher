...
import {
    CompilerHookCallbackParameters,
    CompilationHookCallbackParameters,
    JavascriptParserHookCallbackParameters,
    NormalModuleFactoryHookCallbackParameters,
    ContextModuleFactoryHookCallbackParameters
} from '../options';
...
export abstract class Operation {
    ...
    public normalModuleFactoryHookCallbackParameters: NormalModuleFactoryHookCallbackParameters = new NormalModuleFactoryHookCallbackParameters();
    public contextModuleFactoryHookCallbackParameters: ContextModuleFactoryHookCallbackParameters = new ContextModuleFactoryHookCallbackParameters();
